...
path_history = []  # stores all past positions

html_template = """
<!DOCTYPE html>
<html>
<head>
    <title>Real-Time GPS Tracker with Path</title>
    <meta charset="utf-8" />
...
@app.route('/gps')
def gps_endpoint():
    return jsonify({"lat": gps_data["lat"], "lon": gps_data["lon"], "path": path_history})

def read_gps():
    global gps_data, path_history
    ...
    for new_data in gps_socket:
        if new_data:
            ...
            if data_stream.TPV['lat'] != 'n/a' and data_stream.TPV['lon'] != 'n/a':
                ...
                path_history.append([gps_data["lat"], gps_data["lon"]])
